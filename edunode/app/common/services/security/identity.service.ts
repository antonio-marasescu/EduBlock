...
export class IdentityService {
    ...
    public async getPersonalIdentityDetails(): Promise<PersonalIdentity> {
        this.logger.logInfo(this, 'Getting personal identity details.......');
        const identity = await this.personalIdentityRepository.findPersonalIdentity();
        if (!identity) {
        ...
        this.logger.logSuccess(this, 'Identity found: ' + identity.publicKey);
        this.logger.logInfo(this, 'Clearing sensitive information....');
        identity.privateKey = null as any;
        return identity;
    }
